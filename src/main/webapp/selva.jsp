...
<head>
    ...
    <title>Chasqui PERÙ | Destinos de Selva</title>
...
<body data-region="selva">
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="display-4 fw-bold">ð´ Selva Peruana</h1>
            <p class="lead">Aventura amazÃ³nica, rÃ­os y biodiversidad Ãºnica</p>
        </div>
    </div>
    ...
    <section class="packages-section">
        <div class="container">
            <div class="section-header">
                <h2>ð¦ Nuestros Destinos de Selva</h2>
                <p>Descubre la magia de la AmazonÃ­a peruana</p>
            </div>
