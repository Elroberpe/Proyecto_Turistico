                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-4 pb-3 border-bottom">
                            ...
                            <h4 class="fw-bold text-dark mb-0">
                                ${sessionScope.usuario.nombre} ${sessionScope.usuario.apellidos}
                            </h4>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 py-2 rounded-3" 
                                           name="nombre" value="${sessionScope.usuario.nombre}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Apellidos</label>
                                    <input type="text" class="form-control bg-light border-0 py-2 rounded-3" 
                                           name="apellidos" value="${sessionScope.usuario.apellidos}">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control bg-light border-0 py-2 rounded-3" 
                                           name="email" value="${sessionScope.usuario.email}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Teléfono / Celular</label>
                                    <input type="text" class="form-control bg-light border-0 py-2 rounded-3" 
                                           name="telefono" value="${sessionScope.usuario.telefono}">
                                </div>
                            </div>
