			...
			<div class="card card-auth border-0 p-4 p-sm-5 mx-3 w-100">
				...
				<div class="text-center mb-4">
					<a href="${pageContext.request.contextPath}/index.jsp"
						class="auth-brand">Perú<span>Chasqui</span></a>
				</div>

				<!-- ALERTAS DE ESTADO -->
				<c:if test="${not empty sessionScope.mensaje}">
					<div class="alert alert-success alert-dismissible fade show rounded-3 small py-2 text-center mb-4" role="alert">
				...
				<c:if test="${not empty sessionScope.error}">
					<div class="alert alert-danger alert-dismissible fade show rounded-3 small py-2 text-center mb-4" role="alert">
						${sessionScope.error}
						<button type="button" class="btn-close p-2" data-bs-dismiss="alert" aria-label="Close"></button>
					</div>
				...
				<div id="loginView">
					...
					<div class="text-center mt-4 small text-secondary">
						¿No tienes cuenta?
						<button class="btn btn-link p-0 m-0 align-baseline text-decoration-none fw-bold"
				...
				<div id="registerView" class="d-none">
					...
					<form action="${pageContext.request.contextPath}/AuthServlet" method="post">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control bg-light" name="nombre" placeholder="Tus nombres"
								required>
						</div>
						<div class="mb-3">
