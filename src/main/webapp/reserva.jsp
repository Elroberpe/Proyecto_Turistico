...
<c:if test="${empty sessionScope.usuario}">
    <c:redirect url="/login?redirect=reserva"/>
</c:if>
<!DOCTYPE html>
<html lang="es">
...
<body style="background-color: var(--light-gray);">
            ...
            <div class="col-md-6">
                <div class="payment-card bg-white p-4"
                    ...
                    <form id="paymentForm" action="${pageContext.request.contextPath}/procesarPago" method="post">
                        <!-- Campos ocultos poblados dinámicamente desde reserva.js -->
                        <input type="hidden" name="id_paquete" id="input_id_paquete">
                        <input type="hidden" name="tipo_viaje" id="input_tipo_viaje">
                        <input type="hidden" name="fecha_salida" id="input_fecha_salida">
                        <input type="hidden" name="fecha_retorno" id="input_fecha_retorno">
                        <input type="hidden" name="num_pasajeros" id="input_num_pasajeros">
                        <input type="hidden" name="precio_total" id="input_precio_total">
                        <input type="hidden" name="id_metodo" id="input_id_metodo" value="1">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/reserva.js?v=2.0"></script>
</body>
</html>