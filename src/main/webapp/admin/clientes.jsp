...
<head>
    ...
    <title>Panel Admin TurÏstico - Clientes</title>
    ...
    <div class="d-flex">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/categorias"><i class="bi bi-tags me-2"></i> Categor√≠as</a></li>
                <li><a href="${pageContext.request.contextPath}/admin/paquetes"><i class="bi bi-box-seam me-2"></i> Paquetes</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/admin/clientes"><i class="bi bi-person-badge me-2"></i> Clientes</a></li>
