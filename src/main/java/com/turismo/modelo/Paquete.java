...
public class Paquete {
	...
	public Paquete(int idPaquete, int idCategoria, String nombre, String destino, String descripcion, String imagenUrl,
			BigDecimal precioSoles, String estado) {
	...
	public String toString() {
		return "Paquete{" + "idPaquete=" + idPaquete + ", idCategoria=" + idCategoria + ", nombre='" + nombre + '\''
				+ ", destino='" + destino + '\'' + ", precioSoles=" + precioSoles + ", estado='" + estado + '\'' + '}';
	}
}